    ...
    return WillPopScope(
      onWillPop: () {
        if (currentSelected == 0) {
          return Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => MyHomePage()), (Route<dynamic> route) => false).then((value) => value as bool);
        } else {
