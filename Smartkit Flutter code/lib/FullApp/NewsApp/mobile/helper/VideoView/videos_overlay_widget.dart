...
//    Provider.of<OverlayHandlerProvider>(context, listen: false).enablePip();
    Future.delayed(Duration(milliseconds: 100), () {
      ...
      setState(() {
        isInPipMode = true;
        width = isfullscreen ? videoPlayerController!.value.size.width  : Constant.VIDEO_HEIGHT_PIP;
        height = isfullscreen ? videoPlayerController!.value.size.height  : (Constant.VIDEO_HEIGHT_PIP / aspectRatio) + 33;
