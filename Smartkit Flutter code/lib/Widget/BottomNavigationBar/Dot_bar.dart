...
class _NavigationIconButtonState extends State<_NavigationIconButton> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) => GestureDetector(
      ...
      child: ScaleTransition(scale: _scaleAnimation as Animation<double>, child: AnimatedOpacity(opacity: _opacityIcon, duration: Duration(milliseconds: 200), child: Icon(widget._icon, color: widget._colorIcon))));
}
