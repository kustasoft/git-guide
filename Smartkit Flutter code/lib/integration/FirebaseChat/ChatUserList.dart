  ...
  Widget buildItem(BuildContext context, DocumentSnapshot document) {
    if ((document.data() as Map)['id'] == currentUserId) {
      ...
      return GestureDetector(
        ...
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => MainChatPage(otheruserId: document.id, curruserid: currentUserId, username: (document.data()as Map)['name'])));
        },
      );
    }
  }
