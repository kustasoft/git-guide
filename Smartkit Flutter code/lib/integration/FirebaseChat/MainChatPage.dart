...
class ChatScreenState extends State<ChatScreen> {
        ...
        child: Column(
          children: <Widget>[
            ...
            isLastMessageLeft(index)
                ? Container(
                    child: Text(
                      DateFormat('dd MMM hh:mm a').format(DateTime.fromMillisecondsSinceEpoch(int.parse((document.data() as Map)['timestamp']))),
  ...
  bool isLastMessageLeft(int index) {
    if ((index > 0 && listMessage != null && (listMessage[index - 1].data() as Map)['idFrom'] == curruserid) || index == 0) {
      return true;
    } else {
      return false;
    }
