...
import 'package:smartkit/FullApp/DatingApp/DatingAppMain.dart';
...
class HomeGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List gridlistmobile = [
      {
        'isnew': true,
        'icon': 'assets/datinglogo.svg',
        //'bg': datingcolor1,
        'bg': Colors.white,
        'highlightColor': datingcolor6,
        'iconbg': datingcolor4,
        'iconbgshodw': datingcolor5,
        'title': 'LoveMeet',
        'subtitle': 'Dating App UI',
        'subtitleGradient1': datingcolor2,
        'subtitleGradient2': datingcolor3,
        'screentext': '23+ screens',
        'route': DatingAppMain()
      },
      {
        'isnew': true,
